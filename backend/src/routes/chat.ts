...
import { z } from "zod";
import { handleUserMessage, handleUserMessageStream } from "../services/orchestrator.js";
import { isImageRequest, buildImageUrl } from "../services/imageService.js";
import {
...
chatRouter.post("/chat", async (req, res) => {
  ...
  try {
    ...
    // go straight to Pollinations — no point spending a Groq/OpenRouter
