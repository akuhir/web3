...
// 12mb accommodates base64-encoded photo uploads (base64 adds ~33%
// overhead, so this comfortably covers phone camera photos up to ~8-9MB
// raw — Groq's own vision API caps images at 20MB anyway).
